...
func NewHTTPResponseHendler(log *core_logger.Logger, rw http.ResponseWriter) *HTTPResponseHandler {
...
func (h *HTTPResponseHandler) ErrorRespons(err error, msg string) {
	var (
		statusCode int
