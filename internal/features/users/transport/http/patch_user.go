...
// @Success      200 {object} PatchUserResponse "Пользователь изменненый пользователь"
...
func (h *UsersHTTPHandler) PatchUser(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responseHandler.ErrorRespons(err, "failed to get userID path value")
	...
	if err != nil {
		responseHandler.ErrorRespons(err, "failed to patch user")
